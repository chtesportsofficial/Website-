...
(function () {
  ...
  var translations = {
    en: {
      ...
      "myt.title": "My Tournaments",
      "myt.filter.today": "Today",
      "myt.filter.yesterday": "Yesterday",
      "myt.filter.upcoming": "Upcoming",
      "myt.filter.all": "All",
      "myt.loading": "Loading your tournaments...",
      "myt.filterEmpty": "No tournaments match this filter.",
      "myt.empty.title": "You haven't joined any tournament",
      "myt.empty.sub": "Tournaments you register for will show up here, along with your slot and match details.",
      "myt.empty.browse": "Browse Tournaments",
      "myt.empty.loginTitle": "Please log in",
      "myt.empty.loginSub": "Log in to see the tournaments you have joined and their match details.",
      "myt.empty.loginBtn": "Log In",
      "myt.empty.errorTitle": "Could not load",
      "myt.empty.retryBtn": "Retry",
      "myt.status.confirmed": "CONFIRMED",
      "myt.status.pending": "PENDING",
      "myt.status.cancelled": "CANCELLED",
      "myt.cred.roomId": "Room ID",
      "myt.cred.password": "Password",
      "myt.cred.notPublished": "Not published yet",
      "myt.result.view": "View Result",
      "myt.result.notPublished": "Result not published",
      "myt.note.pending": "📝 Your slot request is being verified. ID, password and result will show here once the admin confirms your payment.",
      ...
      "wallet.minDeposit": "Minimum Deposit: 35 BDT",
      "wallet.minDepositAlert": "Minimum deposit is 35 BDT.",
      "wallet.minWithdrawAlert": "Minimum withdraw is 50 BDT.",
      ...
      "profile.adminPanelSub": "Manage users & stats",
      ...
      "refer.rule2": "Your friend must sign up with your link or code and make a deposit.",
      "refer.rule3": "You'll earn 10% commission on your friend's first deposit. Your friend also gets a bonus: +10% extra on their first deposit.",
      "refer.rule4": "Then you'll earn 5% on every deposit they make after that — but only for 6 months from the day you referred them. After that, you won't earn on their deposits anymore.",
      "refer.rule5": "All commissions are withdrawable immediately — no hold, no waiting period.",
    ...
    bn: {
      ...
      "myt.title": "আমার টুর্নামেন্ট",
      "myt.filter.today": "আজ",
      "myt.filter.yesterday": "গতকাল",
      "myt.filter.upcoming": "আসন্ন",
      "myt.filter.all": "সব",
      "myt.loading": "আপনার টুর্নামেন্ট লোড হচ্ছে...",
      "myt.filterEmpty": "এই ফিল্টারে কোনো টুর্নামেন্ট নেই।",
      "myt.empty.title": "আপনি এখনো কোনো টুর্নামেন্টে যোগ দেননি",
      "myt.empty.sub": "আপনি যে টুর্নামেন্টগুলোতে রেজিস্টার করবেন, সেগুলো আপনার স্লট ও ম্যাচের বিস্তারিতসহ এখানে দেখাবে।",
      "myt.empty.browse": "টুর্নামেন্ট দেখুন",
      "myt.empty.loginTitle": "লগইন করুন",
      "myt.empty.loginSub": "আপনি যে টুর্নামেন্টগুলোতে যোগ দিয়েছেন এবং সেগুলোর ম্যাচ ডিটেইলস দেখতে লগইন করুন।",
      "myt.empty.loginBtn": "লগইন",
      "myt.empty.errorTitle": "লোড করা যায়নি",
      "myt.empty.retryBtn": "আবার চেষ্টা করুন",
      "myt.status.confirmed": "কনফার্মড",
      "myt.status.pending": "পেন্ডিং",
      "myt.status.cancelled": "বাতিল",
      "myt.cred.roomId": "রুম আইডি",
      "myt.cred.password": "পাসওয়ার্ড",
      "myt.cred.notPublished": "এখনো প্রকাশ করা হয়নি",
      "myt.result.view": "রেজাল্ট দেখুন",
      "myt.result.notPublished": "রেজাল্ট প্রকাশ করা হয়নি",
      "myt.note.pending": "📝 আপনার স্লট রিকোয়েস্ট যাচাই করা হচ্ছে। অ্যাডমিন পেমেন্ট কনফার্ম করলে এখানে আইডি, পাসওয়ার্ড ও রেজাল্ট দেখা যাবে।",
      ...
      "wallet.minDeposit": "সর্বনিম্ন ডিপোজিট: ৩৫ টাকা",
      "wallet.minDepositAlert": "সর্বনিম্ন ডিপোজিট ৩৫ টাকা।",
      "wallet.minWithdrawAlert": "সর্বনিম্ন উত্তোলন ৫০ টাকা।",
      ...
      "profile.adminPanel": "অ্যাডমিন প্যানেল",
      "profile.adminPanelSub": "ব্যবহারকারী ও পরিসংখ্যান পরিচালনা করুন",
      "profile.editProfile": "এডিট প্রোফাইল",
      ...
      "refer.rule2": "আপনার বন্ধুকে অবশ্যই আপনার লিংক বা কোড দিয়ে একাউন্ট খুলে ডিপোজিট করতে হবে।",
      "refer.rule3": "বন্ধুর প্রথম ডিপোজিটে আপনি পাবেন ১০% কমিশন। আপনার বন্ধুও বোনাস পাবে — তার প্রথম ডিপোজিটে অতিরিক্ত +১০%।",
      "refer.rule4": "এরপর বন্ধুর প্রতিটি ডিপোজিটে ৫% কমিশন পাবেন, তবে এটা শুধু রেফার করার তারিখ থেকে ৬ মাস পর্যন্ত — এরপর ওই বন্ধুর ডিপোজিট থেকে আর কমিশন পাবেন না।",
      "refer.rule5": "সব কমিশন সাথে সাথে উত্তোলনযোগ্য — কোনো হোল্ড বা অপেক্ষার সময় নেই।",
